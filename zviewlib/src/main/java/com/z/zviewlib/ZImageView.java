...
public class ZImageView extends ImageView {
    ...
    private int
            ...
            zPaddingR,
            zPaddingB;
    private Drawable zDrawable, src;
    //state pressed
    private int
    ...
    private int
            ...
            zSelectedPaddingR,
            zSelectedPaddingB;
    private Drawable zSelectedDrawable, zSelectedSrc;
    //state unabele
    private int
    ...
    private int
            ...
            zUnablePaddingR,
            zUnablePaddingB;
    private Drawable zUnableDrawable, zUnableSrc;
    ...
    public Drawable getzPressedSrc() {
        return zPressedSrc;
    }

    public void setzPressedSrc(Drawable zPressedSrc) {
        this.zPressedSrc = zPressedSrc;
    }

    public Drawable getzSelectedSrc() {
        return zSelectedSrc;
    }

    public void setzSelectedSrc(Drawable zSelectedSrc) {
        this.zSelectedSrc = zSelectedSrc;
    }

    public Drawable getzUnableSrc() {
        return zUnableSrc;
    }

    public void setzUnableSrc(Drawable zUnableSrc) {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            setEnabled(true);
            setImageDrawable(zSelectedSrc);
        } else setImageDrawable(src);
    }
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        src = drawable;
        zPressedSrc = array.getDrawable(R.styleable.ZView_zPressedSrc);
        zSelectedSrc = array.getDrawable(R.styleable.ZView_zSelectedSrc);
        zUnableSrc = array.getDrawable(R.styleable.ZView_zUnableSrc);
        switch (zType) {
            case TYPE_COLOR:
                //state defualt
